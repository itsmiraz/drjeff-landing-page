...
const SuccessStory = () => {
  return (
    <div className="pt-[20px] px-[20px] pb-[150px]">
      <h2 className="font-bold leading-[44px] text-center text-primaryColor text-[30px] md:text-[34px]">
      ...
      <div className="flex md:flex-row flex-col justify-center pt-[40px]  items-center gap-[32px] ">
